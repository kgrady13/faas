...
export function PlaygroundHeader({
  ...
  return (
    <header className="shrink-0 border-b border-border px-3 py-2 md:px-4 md:py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3 relative">
        ...
        {isDevToolsOpen && (
          <div
            ref={popoverRef}
            className="absolute top-full right-0 mt-2 w-[calc(100vw-2rem)] sm:w-72 max-w-72 bg-popover border border-border rounded-lg shadow-lg overflow-hidden z-50"
          >
            {/* Header */}
